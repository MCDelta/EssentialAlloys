...
public class RenderCrusherExtension implements ISimpleBlockRenderingHandler
{
    ...
    public static void doRenderBlock(final IBlockAccess world, final int x, final int y, final int z, final Block block, final RenderBlocks renderer, final int meta,
            final boolean b)
    {
        final EnumFacing face = Assets.getFacing(meta);

        final boolean flag = block == BlockEA.crusherExtMoving;
