...
public class RenderCrusher implements ISimpleBlockRenderingHandler
{
     ...
     {
          float[] arr = BlockShapes.crusherExtended(EnumFacing.UP);
          ...
          float[] arr1 = BlockShapes.crusherHeadThingies(EnumFacing.UP, 0);
          renderer.setRenderBounds(arr1[0], arr1[1], arr1[2], arr1[3], arr1[4], arr1[5]);
          renderBlockItem(renderer, block, 1);
          
          float[] arr2 = BlockShapes.crusherHeadThingies(EnumFacing.UP, 1);
          renderer.setRenderBounds(arr2[0], arr2[1], arr2[2], arr2[3], arr2[4], arr2[5]);
          renderBlockItem(renderer, block, 1);
          
          float[] arr3 = BlockShapes.crusherHeadThingies(EnumFacing.UP, 2);
          renderer.setRenderBounds(arr3[0], arr3[1], arr3[2], arr3[3], arr3[4], arr3[5]);
          renderBlockItem(renderer, block, 1);
          
          float[] arr4 = BlockShapes.crusherHeadThingies(EnumFacing.UP, 3);
     ...
     private void renderBlockItem(RenderBlocks renderer, Block block, int metadata)
     {    
