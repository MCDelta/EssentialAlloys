...
@Mod (modid = EssentialAlloysCore.MOD_ID, name = "EssentialAlloys", useMetadata = true, version = "0.1a", dependencies = "required-after:DeltaCore")
@NetworkMod (clientSideRequired = true, serverSideRequired = false)
public class EssentialAlloysCore implements ModDelta
{
     // TODO
     ...
     public static Map<Block, ItemStack> crusherRecipes   = new HashMap();
     public static Map<Block, ItemStack> explosionRecipes = new HashMap();
     ...
     public void load (FMLInitializationEvent event)
     {
          ...
          OreDictionary.registerOre("ingotSteel", ItemIngot.ingotSteel);
