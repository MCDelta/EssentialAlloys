                    ...
                    if (!stop)
                    {
                        for (int z = radius; z > (-radius - 1); z--)
                        {
                            if (!((Math.abs(x) == radius) && (Math.abs(z) == radius)))
                            {
                                ...
                                if ((Math.abs(x) == radius) || (Math.abs(z) == radius))
                                {
                                    if ((target.getBlock() != Block.netherBrick) && (target.getBlock() != Block.netherFence) && (target.getBlock() != Block.stairsNetherBrick)
                                            && ((target.getBlock() != Block.stoneSingleSlab) || (target.getBlock() != Block.stoneDoubleSlab)) && (target.getMeta() != 6)
                                            && (target.getMeta() != 14))
                                    {
                                        stop = true;
                                        break;
